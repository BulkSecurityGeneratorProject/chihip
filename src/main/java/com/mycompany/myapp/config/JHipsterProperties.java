...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "sample1@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "sample1 API";

        private String description = "sample1 API documentation";
